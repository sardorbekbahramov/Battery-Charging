...
function initBattery() {
    let batteryLiquid = document.querySelector(".Bliquid"),
        batteryStatus = document.querySelector(".Bstatus"),
        Bpercentage = document.querySelector(".Bpercentage");

        console.log(batteryLiquid, batteryStatus, Bpercentage);
    ...
    navigator.getBattery().then((batt)=> {
        updateBattery = ()=> {
            ...
            if(level <= 20) {
                ...
                batteryLiquid.classList.remove("gradient-color-yellow", "gradient-color-orange", "gradient-color-red");
            }
